...
<head>
    ...
    <title>研究開発部　研修資料</title>
</head>
<body>
    <header>
    <h2 id="department">研究開発部　研修資料</h2><a href="{{route('backToIndex')}}" id="logout">ログアウト</a>
    ...
    <div class="menu">
        ...
        <div class="file_menu_hidden" id="file_menu_hidden">
            <div class="form">
            <form method="POST" action="/service_rd_files_ojt" enctype="multipart/form-data">
                {{ csrf_field() }}
